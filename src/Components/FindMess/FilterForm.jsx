...
const FilterForm = (props) => {
  ...
  return (
    <div ref={filterForm} className="hidden h-auto lg:block w-[21vw] bg-zinc-900 p-5 rounded min-h-[82vh]">
      ...
      <div
        ...
        className=' mt-3 border-b border-zinc-400 w-full py-2 relative group'>
        <p>Price Range</p>
        <img src="../Icons/icons8-down-arrow-24.png" alt="" className={`invert absolute right-0 top-1.5  ${isPriceOpen ? 'rotate-180' : 'rotate-0'} transition-all duration-300 ease-in-out`} />
        <div className={`
            
            ${isPriceOpen ? 'max-h-40 opacity-100 my-10' : 'max-h-0 opacity-0 my-0'}
                          max-h-0
                          overflow-hidden
                          opacity-0
                          transition-all 
      ...
      <div
        ...
        className='mt-3 border-b border-zinc-400 w-full py-2 relative group'>
        <p >Amenities</p>
        <img src="../Icons/icons8-down-arrow-24.png" alt="" className={`invert absolute right-0 top-1.5  ${isAmenitiesOpen ? 'rotate-180' : 'rotate-0'} transition-all duration-300 ease-in-out`} />
        <div className={`
          
                        max-h-0
                        overflow-hidden
                        opacity-0
                        ${isAmenitiesOpen ? 'max-h-40 opacity-100 my-10' : 'max-h-0 opacity-0 my-0'}
                        transition-all 
                        duration-400 
                        ease-in-out flex flex-col gap-2 `}>
