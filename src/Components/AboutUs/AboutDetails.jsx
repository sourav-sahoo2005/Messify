...
const AboutDetails = () => {
    ...
    >
      ...
      {/* Heading */}
      <h1 className="animate-item text-4xl font-semibold text-center max-w-4xl leading-tight">
        Moving to a new city should be an adventure, not a struggle.
      </h1>

      {/* Description */}
      <p className="animate-item text-gray-300 text-lg max-w-3xl text-center">
