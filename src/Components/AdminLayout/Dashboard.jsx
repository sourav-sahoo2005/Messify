        ...
        <div className="space-y-8">
            ...
            <div className="flex justify-between items-end">
                <div>
                    ...
                    <p className="text-slate-500 mt-1">Real-time performance of {data.messName}</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-slate-900 rounded-2xl p-8 text-white relative overflow-hidden shadow-2xl">
                    <div className="relative z-10">
                        <h2 className="text-2xl font-bold mb-2">Owner Quick Actions</h2>
                        <p className="text-slate-400 mb-8 max-w-md">Manage your mess efficiently. These shortcuts help you perform common tasks quickly.</p>
